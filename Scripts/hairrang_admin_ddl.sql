...
ALTER TABLE SALES DROP CONSTRAINT SALES_GUESTNO_FK;
ALTER TABLE SALES DROP CONSTRAINT SALES_EVENTNO_FK;
ALTER TABLE SALES_DETAIL DROP CONSTRAINT SALDE_EVENTNO_FK;
ALTER TABLE SALES_DETAIL DROP CONSTRAINT SALDE_HAIRNO_FK;
ALTER TABLE BOOKING DROP CONSTRAINT BOOK_GUESTNO_FK;
