...
AS
SELECT SALES_NO, GUEST_NO, HAIR_NO, EVENT_NO, SALES_DAY, GUEST_NAME, BIRTHDAY, JOIN_DAY, PHONE, GENDER, GUEST_NOTE, HAIR_NAME, PRICE, EVENT_NAME, SALE, TOTAL_PRICE
FROM SALES
...
AS
SELECT BOOK_NO, BOOK_DAY, GUEST_NO, GUEST_NAME, BIRTHDAY, JOIN_DAY, PHONE, GENDER, GUEST_NOTE, HAIR_NO, HAIR_NAME, PRICE, BOOK_NOTE
	FROM BOOKING
	LEFT OUTER JOIN HAIR USING (HAIR_NO) 
	LEFT OUTER JOIN GUEST USING (GUEST_NO) ;
