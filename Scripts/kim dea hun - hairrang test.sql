...
INSERT INTO SALES VALUES (SALES_SEQ.NEXTVAL,TO_DATE('2018-08-25','yyyy-mm-dd'),1,2,1,30000);
...
DELETE sales WHERE sales_no = 13;

INSERT INTO GUEST VALUES(0, '비회원', TO_DATE('1990-02-20', 'YYYY-MM-DD'), SYSDATE, '010-1234-5678', 1, NULL);

SELECT * FROM GUEST;

SELECT TO_DATE(MIN(SALES_DAY ) , 'rrrr-MM-DD') FROM SALES;

SELECT TO_DATE(MIN(SALES_DAY ) , 'yyyy-MM-DD') FROM SALES;

SELECT MIN(SALES_DAY ) FROM SALES;

SELECT * FROM SALES;

 INSERT INTO SALES VALUES (SALES_SEQ.NEXTVAL, TO_DATE('1990-08-22','yyyy-mm-dd'),1,1,1, null);
